...
const HomeScreen = ({ lists, onCreateList, onDeleteList }) => {
  ...
  const getItemCount = (list) => list.items.length;
      ...
      <div className="px-4 py-6">
        {lists.length === 0 ? (
          ...
          >
            <SafeIcon
              icon={FiPackage}
              className="text-6xl text-white/60 mx-auto mb-4"
            />
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-sm">
                          {getItemCount(list)} itens • {getPurchasedCount(list)}{' '}
                          concluídos
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="mt-3">
                    <div className="bg-gray-200 rounded-full h-2">
                      <motion.div
                        ...
                        animate={{
                          width: `${
                            (getPurchasedCount(list) / getItemCount(list)) * 100
                          }%`,
                        }}
